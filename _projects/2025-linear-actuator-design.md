...
<img src="{{ '/assets/images/approach.jpeg' | relative_url }}" alt="Approach diagram" style="width: 50%;">
...
<img src="{{ '/assets/images/non-rigid.jpeg' | relative_url }}" alt="Approach diagram" style="width: 50%;">
